...
<div class="bg-white shadow-md overflow-hidden m-4">
    <div class="md:flex">
        ...
        <div class="p-8">
            <h1 class="text-xl font-bold">DELL Latitude A</h1>
            <h1 class="font-bold text-xl">RM 5900</h1>
            <a href="/add-to-carts" class="bg-gray-800 p-1 rounded-full text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
              <span class="sr-only"></span>
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
            </a> <span class="font-bold">Add to cart</span>
