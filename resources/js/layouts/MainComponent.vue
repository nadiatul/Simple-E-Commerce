  ...
  <main>
      ...
      <div class="row mx-2">
          ...
          <div class="grid-cols-8">
            <div class="inline-block mx-2" v-for="product in products" :key="product">
                <div class="max-w-xs bg-white shadow-md overflow-hidden my-2">
                    ...
                    <div class="flex items-center justify-between px-4 py-2 bg-gray-900">
                        <h1 class="text-gray-200 font-bold text-xl">{{ product.price | discount }}</h1>
...
var getMembershipDiscountUrl = '/api/get-membership-discount/'+ this.user.id;
...
export default ({
    ...
    filters: {
         discount: function (value) {
            ...
            axios.get(getMembershipDiscountUrl).then((response)=>{
